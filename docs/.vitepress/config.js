export default {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2019-present vikoala'
    },
    sidebar: {
      '/blog/': [
        {
        ...
        },
        {
          text: '区块链',
          items: [
            { text: '基础概念', link: '/blog/blockchain/basic' }
          ]
        },
        {
          text: '生活记录',
      ...
      '/blog/frontend/js/': [
        {
          ...
          items: [
            ...
            { text: 'ES6+', link: '/blog/frontend/js/ES6+' },
            { text: '迭代器和生成器', link: '/blog/frontend/js/iterator-generator' },
      ...
      '/blog/frontend/node': [
        {
          text: 'Node.js',
          items: [
            { text: '实现一个 CLI 工具', link: '/blog/frontend/node/custom-cli' },
      ...
      '/blog/frontend/ts': [
        {
          ...
          items: [
            ...
            { text: 'type 与 interface', link: '/blog/frontend/ts/type-interface' },
      ...
      '/blog/frontend/browser': [
        {
          ...
          items: [
            ...
            { text: '回流与重绘', link: '/blog/frontend/browser/layout-painting' },
            { text: 'cookie session token 的区别', link: '/blog/frontend/browser/cookie-session-token' }
          ]
        }
      ],
      '/blog/frontend/tool': [
          ...
          items: [
            {
              text: 'webpack',
              items: [
                { text: 'webpack 入门', link: '/blog/frontend/tool/webpack-basic' },
                { text: '代码压缩', link: '/blog/frontend/tool/compression' },
                { text: 'source-map 配置', link: '/blog/frontend/tool/source-map' },
                { text: '模块化原理', link: '/blog/frontend/tool/webpack-module' },
                { text: '区分环境与代码分离', link: '/blog/frontend/tool/webpack-env' },
                { text: 'devServer 与 HMR', link: '/blog/frontend/tool/devserver' },
              ]
            },
            {
              text: '其他工具',
            ...
            },
            {
              text: '项目实践',
              items: [
                { text: '项目管理规范', link: '/blog/frontend/tool/project-manage' },
                { text: 'git 基本使用', link: '/blog/frontend/tool/git-basic' },
                { text: 'github 工作流', link: '/blog/frontend/tool/github-flow' },
              ]
            },
          ]
        }
